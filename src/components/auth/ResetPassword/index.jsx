...
const ResetPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = apiUrl + "api/auth/confirm-reset-password";
          ...
          <p style={{ color: "#fff" }}>Loading...</p> */}
                ...
                <div className="w-full max-w-xl p-8">
                    ...
                    <div className="w-full max-w-xl bg-white rounded-lg shadow-lg p-8">
                        ...
                        <h2 className="text-xl font-normal text-center mb-4 mt-4 text-gray-700" >パスワードをリセットする</h2>
                        ...
                        <div className="max-w-4xl mx-auto p-4">
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    <label htmlFor="confirmationCode" className="block text-sm font-normal">検証コード</label>
                                    <input
                                        type="text"
                                ...
                                <div className="relative">
                                    <label htmlFor="newPassword" className="block text-sm font-normal">新しいパスワード</label>
                                    <input
