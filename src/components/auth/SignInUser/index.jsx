...
const SignInUser = () => {
  const { signinUser, signinSSO, signinOIDCSSO } = useAuth();
  ...
  //     console.log("sign-in query: ", query.get("username"));
  //   }, [location]);
      ...
      <div className="min-h-screen flex justify-center items-center bg-[#FEF3F3]">
        ...
        <div className="w-full max-w-xl p-8">
          ...
          <div className="w-full max-w-xl bg-white rounded-lg shadow-lg p-8">
            ...
            <h2 className="text-xl font-normal text-center mb-4 mt-4 text-gray-700">
              ログイン
            </h2>
            <div className="max-w-4xl mx-auto p-4">
              <div className="tabs">
                ...
                <div className="tab-list flex space-x-1 justify-center">
                  <button
                    className={`tab-title  text-lg font-normal w-1/2 ${
                      activeTab === 0
                  ...
                  {activeTab === 0 && (
                    <div>
                      <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                          <h2 className="text-lg font-normal text-center mb-8 mt-4 text-gray-700">
                            114Salut Station連携済のお客様
                          </h2>
                        </div>
                        <div>
                          <label
                      ...
                      <div className="flex items-center justify-center">
                        <button
                          onClick={handleOIDCSSOLogin}
                          className="w-full h-full mt-2 mb-2 px-2 py-3 rounded-full border-2 border-[#2874a6] font-normal text-sm bg-[#2874a6] text-white  "
                        >
                          <div className="flex items-center justify-center space-x-2">
                            <img
                              src="https://cdn.zonebourse.com/static/instruments-logo-6492265"
                    ...
                    <div>
                      ...
                      {/* <div className="flex items-center justify-center">
                        <button
                          ...
                          className="w-full h-full mt-2 mb-2 px-2 py-3 rounded-full border-2 border-red-600 font-normal text-sm bg-transparent text-white  hover:text-red-600 hover:bg-transparent"
                        >
                          ...
                          <div className="flex items-center justify-center space-x-2">
                            <img
                              ...
                              alt=""
                            />
                            <span className="text-sm font-normal text-center text-gray-700">
                              百十四銀行 Banker SAML-SSO ログイン
                            </span>
                          </div>
                        </button>
                      </div> */}
